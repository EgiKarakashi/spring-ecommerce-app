...
@OpenAPIDefinition(info = Info(title = "Sampledata Service API", description = "Sampledata API documentation",
    version = "1.0"), security = [SecurityRequirement(name = "oauth2_bearer")],
    servers = [Server(url = "\${server.servlet.context-path}", description = "Description Server URL")])
