  ...
  const handleFetch = async () => {
    try {
      ...
      if (response.message !== null) {
        toastSuccess("Sample data added successfully");
        window.location.reload();
      }
    } catch (error: any) {
      if (error.message === 403) toastError("Please login to add sample data");
        ...
        <div className="row">
          ...
          <div className="col-sm-6 col-lg-3 p-b-50">
            ...
            <div className="p-t-27">
              <Link
                href="https://github.com/EgiKarakashi/spring-ecommerce-app/"
                target={'_blank'}
