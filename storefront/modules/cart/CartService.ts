...
import {CartItemGetDetailsVm, CartItemGetVm} from "@/modules/cart/models/CartItemGetVm";
import {CartItemDeleteVm} from "@/modules/cart/models/CartItemDeleteVm";
import {CartItemPutVm} from "@/modules/cart/models/ProductSlug";
...
async function throwDetailedError(response: Response) {
  ...
  throw new EcommerceError(errorResponse);
}
