...
import DetailHeader from "@/modules/catalog/components/DetailHeader";
import {ProductImageGallery} from "@/common/components/ProductImageGallery";
import Link from "next/link";
import {addCartItem} from "@/modules/cart/CartService";
...
export default function ProductDetails({
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (error instanceof EcommerceError && error.status === 403) {
